        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 max-w-2xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold tracking-tight text-foreground leading-[1.1]">
              Find a place you will call <span className="text-muted-foreground/70 decoration-4 decoration-border underline-offset-4">home</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-border mt-8">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground uppercase tracking-wide">Happy Clients</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
             ...
             <PlaceholderImage 
               ...
               text="Hero Image: Modern Luxury Villa" 
               className="shadow-xl border-4 border-background"
             />
          </div>
