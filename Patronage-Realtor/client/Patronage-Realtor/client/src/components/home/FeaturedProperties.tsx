  ...
  return (
    <section id="featured-properties" className="container mx-auto px-4 py-16 md:py-24">
      <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
        ...
        <Link
          href="/properties"
          className={cn(buttonVariants({ variant: "outline" }), "hidden md:inline-flex gap-2")}
        >
          ...
          <Card key={property.id} className="overflow-hidden group border-border shadow-sm hover:shadow-md transition-shadow">
            ...
            <CardContent className="p-6">
              ...
              <div className="flex items-center justify-between text-sm text-muted-foreground pt-4 border-t border-border">
                ...
                <span className="flex items-center gap-1"><Square className="h-4 w-4" /> {property.sqft} sq.ft</span>
              </div>
            </CardContent>
